      ...
      <div className="max-w-6xl mx-auto px-6 md:px-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="flex flex-col gap-8 md:pl-4">
            {/* Heading */}
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-medium text-[#131313] leading-tight tracking-tight font-['Plus_Jakarta_Sans']">
              Managing your business just got easier with the{" "}
              <span className="font-semibold">Yacht Crew Center</span>.
            </h2>

            {/* Paragraphs */}
            <div className="flex flex-col gap-6 text-lg lg:text-xl text-[#373737] leading-relaxed font-light">
              <p>
            ...
            <div className="mt-4">
              <Link to="/apply">
                <button className="group relative overflow-hidden rounded-lg bg-gradient-to-r from-[#034D92] to-[#0487D9] px-10 py-4 font-semibold text-white text-base sm:text-lg transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
