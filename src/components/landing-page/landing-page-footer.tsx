        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 py-8">
          ...
          <div className="col-span-1 md:col-span-5">
            <div className="flex flex-col items-center md:items-start gap-4">
              <img src={logo} alt="logo" className="w-[70px] h-[65px]" />
              <Link to="/contact-us" className="no-underline">
                <button
                  className="px-5 py-3 text-white font-inter font-semibold text-base leading-[19px] 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {footerData.map((section, idx) => (
                <div key={idx} className="mb-6 md:mb-0">
                  {/* Section Title */}
                  <h3
                    className="font-['Plus_Jakarta_Sans'] font-semibold text-xl leading-[120%] 
                    text-white uppercase text-start mb-2 break-words md:whitespace-nowrap"
                  >
                    {section.title}
                  </h3>
                  ...
                  <ul className="list-none p-0">
                    {section.links.map((link, linkIdx) =>
                      link.external ? (
                        <li key={linkIdx} className="pl-0 py-1.5">
                          <a
                            href={link.path}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="font-['Plus_Jakarta_Sans'] font-normal text-base leading-6 
                            text-white no-underline transition-all duration-300 ease-in-out 
                            relative inline-block break-words md:whitespace-nowrap
                            hover:text-[#0487D9] hover:translate-x-1.5
            ...
            <div className="border-t border-white/10 mt-6 pt-6">
              <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                <div className="col-span-1 md:col-span-8">
                  <div className="flex flex-col sm:flex-row items-center md:items-start gap-2.5 sm:gap-0">
                    <p className="font-['Plus_Jakarta_Sans'] font-normal text-base leading-[21px] text-[#E0E0E0] text-center md:whitespace-nowrap whitespace-normal">
                      © {new Date().getFullYear()} SC Yacht Crew Center LLC . All
                      Rights Reserved.
                    </p>
                    <span className="hidden sm:inline mx-4 text-[#E0E0E0]">|</span>
                    <button
                      ...
                      relative font-['Plus_Jakarta_Sans'] font-normal text-sm leading-[18px] 
                      whitespace-nowrap
                      hover:text-[#0487D9] hover:translate-x-1.5
                      after:content-[''] after:absolute after:w-0 after:h-0.5 after:bottom-[-2px] 
                      after:left-0 after:bg-[#0487D9] after:transition-all after:duration-300
                ...
                <div className="col-span-1 md:col-span-4">
                  <div className="flex justify-center md:justify-end gap-2.5 mt-4 md:mt-0">
                    <a
